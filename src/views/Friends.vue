  ...
  <div class="friends-container">
        ...
        <div class="card-header">
          ...
          <div class="header-actions">
            ...
            <template v-if="selectionMode">
              ...
              <el-button type="success" :icon="Check" @click="openBatchTaskDialog" :disabled="!license.isActive">
        ...
        <el-table-column label="操作" width="120" fixed="right">
          <template #default="{ row }">
            <el-dropdown @command="(cmd) => handleCommand(cmd, row)" trigger="click">
              ...
              <template #dropdown>
                <el-dropdown-menu>
                  <el-dropdown-item command="send" :disabled="!license.isActive">发送消息</el-dropdown-item>
                  <el-dropdown-item command="create" :disabled="!license.isActive">创建任务</el-dropdown-item>
                </el-dropdown-menu>
              </template>
            </el-dropdown>
          </template>
    ...
    <el-dialog v-model="sendDialogVisible" title="发送消息" width="500px" destroy-on-close>
      ...
      <template #footer>
        ...
        <el-button type="primary" @click="handleSend" :loading="sendLoading" :disabled="!license.isActive">发送</el-button>
      </template>
    </el-dialog>
    ...
    <el-dialog v-model="taskDialogVisible" title="创建定时任务" width="500px" destroy-on-close>
      ...
      <template #footer>
        ...
        <el-button type="primary" @click="handleCreateTask" :loading="taskLoading" :disabled="!license.isActive">创建</el-button>
      </template>
    </el-dialog>
...
const handleSend = async () => {
  if (!license.isActive) {
    ElMessage.warning('未激活授权,无法发送消息,请在「设置-授权信息」中激活')
    return
  }
...
const handleCreateTask = async () => {
  if (!license.isActive) {
    ElMessage.warning('未激活授权,无法创建任务,请在「设置-授权信息」中激活')
    return
  }
