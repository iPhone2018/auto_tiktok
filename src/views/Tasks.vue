  ...
  <div class="tasks-container">
    <el-card>
      <template #header>
        <div class="card-header">
          ...
          <div class="header-buttons">
            ...
            <el-button v-if="!selectionMode" type="success" :icon="Plus" @click="openAddDialog" :disabled="!license.isActive">
              添加任务
            </el-button>
      ...
      <el-empty v-if="!loading && taskList.length === 0" description="暂无定时任务">
        <el-button type="primary" @click="openAddDialog" :disabled="!license.isActive">添加第一个任务</el-button>
      </el-empty>
    </el-card>
...
const handleSubmit = async () => {
  if (dialogMode.value === 'add' && !license.isActive) {
